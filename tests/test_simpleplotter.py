...
class SimplePlotterTest(tb.BasePlotterTest):
    """Test class for :class:`psyplot.plotter.simpleplotter.SimplePlotter`

    .. todo::
      Implement testing of plot formatoption"""
    ...
    def ref_transpose(self, close=True):
        ...
        Create reference file for
        :attr:`~psyplot.plotter.simpleplotter.SimplePlotter.transpose`
        formatoption"""
        sp = self.plot()
    ...
    def ref_legend(self, close=True):
        ...
        Create reference file for
        :attr:`~psyplot.plotter.simpleplotter.SimplePlotter.legend`
        formatoption"""
        sp = self.plot(
    ...
    def _test_DataTicksCalculator(self):
        # testing of psyplot.plotter.simpleplotter.DataTicksCalculator
    ...
    def _test_DtTicksBase(self, *args):
        # testing of psyplot.plotter.simpleplotter.DtTicksBase
        args = iter(args)
        data = InteractiveList.from_dataset(
            self.data[0].base, lat=[0, 1], lev=0, lon=0, name='t2m',
            auto_update=True)
        plotter = SimplePlotter(data)
        ax = plotter.ax
...
class References2D(object):
    ...
    def ref_datagrid(self, close=True):
        ...
        Create reference file for
        :attr:`~psyplot.plotter.simpleplotter.Simple2DPlotter.datagrid`
        formatoption"""
    ...
    def ref_cmap(self, close=True):
        ...
        Create reference file for
        :attr:`~psyplot.plotter.simpleplotter.Simple2DPlotter.cmap`
        formatoption"""
    ...
    def ref_cbar(self, close=True):
        ...
        Create reference file for
        :attr:`~psyplot.plotter.simpleplotter.Simple2DPlotter.cbar`
        formatoption"""
    ...
    def ref_miss_color(self, close=True):
        ...
        Create reference file for
        :attr:`~psyplot.plotter.simpleplotter.Simple2DPlotter.miss_color`
        formatoption"""
    ...
    def ref_cbarspacing(self, close=True):
        ...
        Create reference file for
        :attr:`~psyplot.plotter.simpleplotter.Simple2DPlotter.cbarspacing`
        formatoption"""
...
class Simple2DPlotterTest(SimplePlotterTest, References2D):
